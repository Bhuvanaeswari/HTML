const initial=()=>
{
    participants={"name":["rithika","yashika","anush"],"age":[30,12,23],"weight":[55,34,44],"contact":[995283040,986504567,890789567],"tournament":["football","cricket","tennis"],"score":[50,20,30]}
...
const viewing=()=>
{
   ...
   // const tournmap=temp["tournament"].map((data)=>{return collect5+="<td>"+data+"</td>"})
    ...
    place.innerHTML="<table  border='5px',style='text-align:center'><thead><tr><th>NAME</th><th>AGE</th><th>WEIGHT</th><th>CONTACT NO</th><th>TOURNAMENT</th></tr></thead><tbody> <tr>"+"<td>"+collect1+"</td>"+"<td>"+collect2+"</td>"+"<td>"+collect3+"</td>"+"<td>"+collect4+"</td>"+"<td>"+collect5+"</td>"+"</tr></tbody></table>"
...
const searching=()=>
{
    ...
    place.innerHTML="<table  border='5px',style='text-align:center'><thead><tr><th>NAME</th><th>AGE</th><th>WEIGHT</th><th>CONTACT NO</th><th>TOURNAMENT</th><th>ACTION</th></tr></thead><tbody><tr>"+"<td>"+collect1+"</td>"+"<td>"+collect2+"</td>"+"<td>"+collect3+"</td>"+"<td>"+collect4+"</td>"+"<td>"+collect5+"</td>"+"<td>"+"<button onclick=editing()>EDIT</button>"+"</td></tr></tbody></table>"
